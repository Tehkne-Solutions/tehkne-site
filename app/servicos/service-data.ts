...
export const servicePages: ServicePageData[] = [
  ...
  },
  {
    ...
    promise: 'Mantenha seu site ou sistema vivo, seguro, rápido e pronto para evoluir.',
    pain: 'Depois do lançamento começam atualizações, bugs, campanhas, novos conteúdos, mudanças de stack, integrações e urgências. Sem sustentação, o projeto acumula risco e dependência. Com governança, cada melhoria entra em uma fila clara e rastreável.',
    authority: 'A Tehkné estrutura rotina de sustentação com auditoria, versionamento, documentação viva, performance, correções, SEO técnico, suporte e evolução. Não é apenas apagar incêndio: é criar continuidade técnica.',
    outcomes: ['Menos risco em produção', 'Correções priorizadas', 'Performance monitorada', 'Backups e atualizações controladas', 'Documentação viva', 'Evolução sem refazer tudo'],
    deliverables: ['Auditoria técnica', 'Plano de sustentação', 'Backlog evolutivo', 'Correções e melhorias', 'Performance e SEO técnico', 'Documentação e governança'],
    process: [['01', 'Auditoria', 'Levantamos estado atual, riscos e prioridades.'], ['02', 'Plano técnico', 'Organizamos backlog, rotinas e responsabilidades.'], ['03', 'Sustentação', 'Executamos correções, melhorias e suporte.'], ['04', 'Evolução', 'Planejamos novas fases com base em dados e uso real.']],
    bestFor: ['Sites em produção', 'WordPress crítico', 'Projetos herdados', 'Operações com tráfego', 'Times sem suporte técnico'],
    stack: ['Git', 'QA', 'WordPress', 'Vercel', 'Analytics'],
    relatedCases: ['Beggin', 'UNTI Digital', 'Savana Publicidade'],
    cta: 'Avaliar sustentação'
  },
  {
    icon: Building2,
